...
- USS-transferred records, locked invoices, audit records, tooth history, and commission records are immutable.
...
- Patient identifiers must be masked according to role.
