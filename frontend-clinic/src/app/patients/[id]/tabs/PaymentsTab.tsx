...
export default function PaymentsTab({ patient }: { patient: any }) {
  ...
  // eslint-disable-next-line react-hooks/incompatible-library -- react-hook-form's watch() cannot be memoized safely, no low-risk fix available
