...
export default function DentalChart({
  ...
  // Dişe ait tüm treatment plan öğelerini getir
  ...
  // Tüm treatment overlay URL'lerini topla (üst üste binecek)
  ...
  function renderTooth(n: number, isTop: boolean) {
    ...
    // Üst diş: numara üstte, görsel altta | Alt diş: görsel üstte, numara altta
    return (
      <div
        key={n}
